...
const YogyakartaKosPage = () => {
    ...
    // Fetch kos data untuk Yogyakarta
    const fetchYogyakartaKos = async (filters: {
        kalender?: string;
        gender?: string;
        price?: string;
        kampus?: string;
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-600">Memuat data kos Yogyakarta...</p>
                </div>
            </div>
        );
    }
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600">
                            Temukan kos terbaik di area Yogyakarta sesuai kebutuhan Anda
                        </p>
                    </div>
                            ...
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-500">
                                    {selectedKalender !== "all" || selectedGender !== "all" || selectedPrice !== "all" || selectedKampus !== "all" || searchQuery.trim() !== ""
                                        ...
                                        : "Belum ada kos yang tersedia di Yogyakarta"
                                    }
                                </p>
                            </div>
                        )
